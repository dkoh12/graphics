...
public class Subdiv2D {
    ...
    {
        Mat ptvec_mat = ptvec;
        insert_0(nativeObj, ptvec_mat.nativeObj);
    ...
    public  int insert(Point pt)
    {
        ...
        int retVal = insert_1(nativeObj, pt.x, pt.y);
    ...
    // C++:  void insert(vector_Point2f ptvec)
    private static native void insert_0(long nativeObj, long ptvec_mat_nativeObj);
    ...
    // C++:  int insert(Point2f pt)
    private static native int insert_1(long nativeObj, double pt_x, double pt_y);
